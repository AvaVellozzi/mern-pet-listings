...
//all get requests below this point are password protected
...
app.post("/create-animal", upload.single("photo"), ourCleanup, async (req, res) => {
    //resizing uploaded photo to fit box
    if (req.file) {
